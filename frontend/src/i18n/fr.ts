...
export const fr: Record<TranslationKey, string> = {
  ...
  topbar_streaming_suffix: " · en cours…",
  ...
  mistakes_done_prefix: "Analyse terminée · ",
  mistakes_click_hint: "Cliquez sur une faute pour la mettre en évidence sur le PDF.",
  modal_title: "Texte à anonymiser :",
  modal_input_placeholder: "ex. Pierre Dupont",
  modal_all_occurrences_note: "Toutes les occurrences exactes seront anonymisées.",
  modal_label_heading: "Comme :",
  modal_cancel: "Annuler",
  modal_add_button: "Ajouter",
  debug_download_button: "Télécharger le dump (JSON)",
  debug_markdown_raw: "Markdown extrait",
  debug_markdown_anonymized: "Markdown anonymisé (envoyé au LLM)",
  debug_mistakes: "Fautes (JSON)",
